...
class DigitDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Handle relative paths - paths are relative to data/digit_classification/
        if not os.path.isabs(image_path):
            image_path = os.path.join("data/digit_classification", image_path)
...
# ---------------------------
def main():
    dataset = DigitDataset('data/digit_classification/digits/labels.txt', transform=transform)
    ...
    # Prepare HDF5 file
    h5_path = "models/weights/digit_embeddings.h5"
