...
if __name__ == "__main__":
    ...
    images_path = "data/digit_classification/digits/images"
    labels_path = "data/digit_classification/digits/labels.txt"
    os.makedirs(images_path, exist_ok=True)
    
    # Load MNIST first to know how many images to match
    mnist_data = MNIST(root="../../sudoku_digit_classification/mnist_data", train=True, download=True)
